...
class 六爻卦 {
    ...
    constructor(初爻:爻,
                ...
                五爻:爻,
                上爻:爻) {
        // console.log(object)里显示的顺序是赋值的顺序 囧
        let 内卦 = new 三爻卦(初爻,二爻,三爻);
        let 外卦 = new 三爻卦(四爻,五爻,上爻);
        this.卦名 = names[外卦.卦名[1]][内卦.卦名[1]];
        if(!this.卦名) {
            throw new Error("卦名没读出来");
        }
        this.外卦 = 外卦;
        this.内卦 = 内卦;
        this.世应 = this.定世应(初爻,二爻,三爻,四爻,五爻,上爻);
        if(!this.世应) {
    ...
    public 定世应(初爻:爻,
        ...
        五爻:爻,
        上爻:爻):[爻,爻] {
        if(上爻.阴阳()==三爻.阴阳() && 五爻.阴阳()==二爻.阴阳() && 四爻.阴阳()==初爻.阴阳()) {
            return [上爻,三爻];
        }
        if(上爻.阴阳()==三爻.阴阳() && 五爻.阴阳()==二爻.阴阳() && 四爻.阴阳()!=初爻.阴阳()) {
            return [初爻,四爻];
